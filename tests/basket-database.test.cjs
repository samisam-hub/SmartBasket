...
test('basket tables/RPC enforce two-user isolation, atomic saves, retries, foreign keys and append-only permissions', async () => {
  ...
  try {
    ...
    for (const file of ['20260906005004_products_catalog.sql','20260906124417_product_image_quality.sql','20260906131336_generated_baskets.sql','20260906194141_meal_based_baskets.sql','20260907081513_ingredient_package_metadata.sql','20260907120000_synthetic_price_metadata.sql'])
